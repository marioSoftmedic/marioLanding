...
I spent the last few days fixing complex issues in [Examya's](/en/examya) medical order flow. The system has a WhatsApp agent called Shuri that manages everything from the initial consultation to order creation.
