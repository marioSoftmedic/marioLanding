**What**: Generar borrador de blog post sobre pagos por WhatsApp basado en trabajo reciente de Examya
**Why**: Contexto reciente muestra mucho trabajo con WhatsApp OCR, flujos de pago y arquitectura de sistemas
**Where**: /root/repos/obsidian-vault/Proyectos/05_Blog/borradores/2026-04-18-pagos-whatsapp-mercadopago-stripe.md
**Learned**: Usar observaciones reales de Engram como fuente, no inventar detalles técnicos

---
title: "De 0 a pagos por WhatsApp: Mercado Pago + Stripe desde una conversación"
date: 2026-04-18
lang: "es"
description: "Cómo construí un sistema de pagos integrado en WhatsApp que procesa órdenes médicas y cobra automáticamente Mercado Pago y Stripe."
...
function getPendingOrc(userId: string): string | undefined {
...
2. Sistema valida formato y digito verificador
3. Si válido, procede con el pago
4. Si inválido, solicita formato correcto

La validación oculta en segundo plano para no interrumpir la conversación.
...
Segundo, los proveedores de pago tienen comportamientos muy distintos. Mercadopago funciona mejor para pagos rápidos dentro de Chile. Stripe es necesario para internacional pero rompe la experiencia fluida de WhatsApp.
...
Lo importante no es que puedas cobrar por WhatsApp. Es que puedes reducir la fricción en el sistema de salud.

Un paciente puede pedir exámenes desde su celular. Pagar sin complicaciones. Recibir resultados sin papeles. Todo en una conversación natural.

Esa es la verdadera innovación.

---

¿Listo para transformar tu sistema de pagos? Escribe a mario.inostroza.m@gmail.com o contáctame en @marioinostroza en X. Construyo estos sistemas para empresas reales con problemas complejos.