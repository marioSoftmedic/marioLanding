...
Los últimos días los dediqué a resolver problemas complejos en el flujo de órdenes médicas de [Examya](/examya). El sistema tiene un agente de WhatsApp llamado Shuri que gestiona todo el proceso desde la consulta inicial hasta la creación de órdenes.
