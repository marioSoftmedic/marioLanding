...
[Law 21.668](/en/blog/2026-04-16-ley-21668-interoperabilidad-salud-chile-oportunidad-examya) requires healthcare providers to adopt measures that enable clinical record interoperability. Laboratory results can form part of that record and exchange context.

A well-formed FHIR DiagnosticReport can provide the structured result, coded study, patient identifier, and reference to the originating order. Whether it satisfies an applicable requirement also depends on regulation, profiles, identity, access control, and governance.

A flow that currently depends on PDF, email, and manual entry can become machine-to-machine: the lab validates, the DiagnosticReport changes to `final`, and an authorized system can receive the update through an agreed FHIR workflow.

## The missing link in the chain

Previous posts in this series covered the legal interoperability requirement ([Law 21.668](/en/blog/2026-04-16-ley-21668-interoperabilidad-salud-chile-oportunidad-examya)), labs as key actors ([clinical laboratories](/en/blog/2026-04-17-laboratorios-clinicos-clave-transformacion-digital-salud-chile)), and the technical adapter layer ([FHIR + Law 21.668](/en/blog/2026-04-18-fhir-ley-21-668-interoperabilidad-chile)).
