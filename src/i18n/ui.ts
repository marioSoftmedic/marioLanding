...
export const ui = {
	es: {
		...
		"section.about.subtitle":
			"Tecnólogo Médico convertido en AI Builder desde Puerto Natales, Patagonia.",
		// Projects section
		"section.projects.label": "Portafolio",
		"section.projects.title": "Proyectos",
		"section.projects.subtitle":
			"Agentes de IA, bots conversacionales y sistemas autónomos",
		...
		"blog.page.meta.desc":
			"Artículos sobre IA, agentes autónomos y desarrollo de software desde la Patagonia.",
		"blog.page.label": "Escritura",
		"blog.page.heading": "Blog",
		"blog.page.subtitle":
			"IA, agentes y lo que aprendo construyendo desde la Patagonia.",
		"blog.page.empty": "Próximamente — el primer post está en camino.",
		"blog.post.back": "Blog",
		"blog.post.author": "Mario Inostroza",
		// Tags index page
		"blog.tags.meta.title": "Etiquetas — Mario Inostroza",
		"blog.tags.meta.desc":
			"Explorá los temas que cubre el blog: IA, agentes, salud digital, infraestructura.",
		"blog.tags.label": "Etiquetas",
		"blog.tags.heading": "Temas del blog",
		"blog.tags.subtitle":
			"Tamaño según cantidad de posts. Hacé clic en un tema para ver todo lo escrito al respecto.",
		"blog.tags.empty": "Todavía no hay etiquetas.",
		// Tag detail page
		"blog.tag.meta.suffix": "etiqueta — Mario Inostroza",
		"blog.tag.meta.desc": "Posts etiquetados con {tag}.",
		"blog.tag.back": "Todas las etiquetas",
		"blog.tag.label": "Etiqueta",
		"blog.tag.count.one": "post",
		"blog.tag.count.many": "posts",
		// Related / Series
		"blog.related.heading": "Lecturas relacionadas",
		"blog.related.reason.related": "Recomendado",
		"blog.related.reason.series": "En esta serie",
		"blog.related.reason.tags": "Por temas similares",
		"blog.series.label": "Serie",
		"blog.series.position": "Parte {n} de {total}",
		// Contact section
		...
		"meta.description":
			"Desarrollador Fullstack · AI Builder · Puerto Natales, Patagonia",
	},
	en: {
		// Nav
		...
		"section.about.subtitle":
			"Medical Technologist turned AI Builder from Puerto Natales, Patagonia.",
		// Projects section
		"section.projects.label": "Portfolio",
		"section.projects.title": "Projects",
		"section.projects.subtitle":
			"AI agents, conversational bots and autonomous systems",
		...
		"blog.page.meta.title": "Blog — Mario Inostroza",
		"blog.page.meta.desc":
			"Articles about AI, autonomous agents and software development from Patagonia.",
		...
		"blog.post.author": "Mario Inostroza",
		// Tags index page
		"blog.tags.meta.title": "Tags — Mario Inostroza",
		"blog.tags.meta.desc":
			"Browse what the blog covers: AI, agents, digital health, infrastructure.",
		"blog.tags.label": "Tags",
		"blog.tags.heading": "Blog topics",
		"blog.tags.subtitle":
			"Sized by post count. Click a topic to see everything written about it.",
		"blog.tags.empty": "No tags yet.",
		// Tag detail page
		"blog.tag.meta.suffix": "tag — Mario Inostroza",
		"blog.tag.meta.desc": "Posts tagged {tag}.",
		"blog.tag.back": "All tags",
		"blog.tag.label": "Tag",
		"blog.tag.count.one": "post",
		"blog.tag.count.many": "posts",
		// Related / Series
		"blog.related.heading": "Related reading",
		"blog.related.reason.related": "Recommended",
		"blog.related.reason.series": "In this series",
		"blog.related.reason.tags": "Similar topics",
		"blog.series.label": "Series",
		"blog.series.position": "Part {n} of {total}",
		// Contact section
		...
		"meta.title": "Mario Inostroza — Software Engineer & AI Builder",
		"meta.description":
			"Fullstack Developer · AI Builder · Puerto Natales, Patagonia",
	},
} as const;
