...
export const ui = {
  es: {
    ...
    'blog.tags.meta.desc': 'Explorá los temas que cubre el blog: IA, agentes, salud digital, infraestructura.',
    'blog.tags.label': 'Etiquetas',
    'blog.tags.heading': 'Temas del blog',
    'blog.tags.subtitle': 'Tamaño según cantidad de posts. Hacé clic en un tema para ver todo lo escrito al respecto.',
  ...
  en: {
    ...
    'blog.tags.meta.desc': 'Browse what the blog covers: AI, agents, digital health, infrastructure.',
    'blog.tags.label': 'Tags',
    'blog.tags.heading': 'Blog topics',
    'blog.tags.subtitle': 'Sized by post count. Click a topic to see everything written about it.',
