...
export const TAG_TAXONOMY: TagDef[] = [
	...
	},
	{
		...
		aliases: ["databases", "database", "bases de datos", "base de datos"],
	},
	{
		slug: "openai",
		label: { es: "OpenAI", en: "OpenAI" },
		aliases: ["openai"],
	},
	{
		slug: "spanish",
	...
	},
	{
		...
		aliases: ["diagnostics", "diagnóstico", "diagnostico"],
	},
	{
		slug: "hardware",
		label: { es: "Hardware", en: "Hardware" },
		aliases: ["hardware"],
	},
	{
		slug: "corfo",
		label: { es: "CORFO", en: "CORFO" },
		aliases: ["corfo"],
	},
	{
		slug: "resilience",
		label: { es: "Resiliencia", en: "Resilience" },
		aliases: ["resilience", "resiliencia"],
	},
	{
		slug: "magallanes",
		label: { es: "Magallanes", en: "Magallanes" },
		aliases: ["magallanes"],
	},
	{
		slug: "builder",
		label: { es: "Builder", en: "Builder" },
		aliases: ["builder"],
	},
	{
		slug: "prospecting",
		label: { es: "Prospectos", en: "Prospects" },
		aliases: ["prospecting", "prospectos", "prospects"],
	},
	{
		slug: "clinics",
...
const SLUG_TO_DEF: Map<string, TagDef> = new Map(
	TAG_TAXONOMY.map((d) => [d.slug, d]),
);
 ...
 */
export function tagsForPost(
	rawTags: readonly string[] | undefined | null,
): string[] {
